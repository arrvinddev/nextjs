...
import { PORT, SESSION_MAX_AGE, SESSION_SECRET } from './config';



const DATABASE_URL=`postgres://postgres:root2024A@testdb.ctj3kqz05qda.us-east-1.rds.amazonaws.com/sampledb`
// smartpipedev/devsmartpipedbv4
